...
export async function PATCH(
  ...
  const wedding = await prisma.wedding.update({
    ...
    data: {
      ...
      ...(typeof coverImagePosX === "number" ? { coverImagePosX } : {}),
      ...(typeof coverImagePosY === "number" ? { coverImagePosY } : {}),
      ...(typeof coverImageScale === "number" ? { coverImageScale } : {}),
      ...(typeof titleFontScale === "number" ? { titleFontScale } : {}),
